...
def logo_taekyung():
    try:
        ...
        os.system("xdg-open https://www.youtube.com/@Ferr Official")
        time.sleep(3)
        os.system('clear')
        mengetik('\033[36;1mINGIN MENGHUBUNGI SAYA \033[37;1mF3RZ-SIBER')
        os.system('xdg-open https://wa.me/+6283857242250/')
        time.sleep(3)
                 ...
                 `Mh`+ sdMNNNNMh`     NMosMN     `dMMMMMdo`/`hN
                  ...
                  /d`/ss mNNNNN-      `d.-h`      -NNNNd ss/`d:
                   ...
                   `doss/++.mNh                    hNm`o ss/d:
                     ...
                     ***     POWERED  BY  F3RZ-SIBER      ***
                     ****      EXECUTOR  F3RZ-SIBER      ****
\033[33;1m╔════════════════════════════════════════════════╗
\033[33;1m║  \033[36;1m [•] Authour : F3RZ-SIBER           \033[33;1m ║
\033[33;1m║  \033[36;1m [•] gitHub  : F3RZ-SIBER           \033[33;1m |
\033[33;1m║  \033[36;1m [•] Facebook: F3RZ-SIBER           \033[33;1m ║
\033[33;1m╚════════════════════════════════════════════════╝
\033[36;1m╔═══════════════════════════╗
...
def put():
    ...
    try:
        ...
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m LEBOKNO JUMLAH \033[1;33m• \033[0m\033[1;30m]═════════════>")
        ...
        sys.exit(f"{W}[{R}!{W}] Metu!!{abu}...{W}")
    except ValueError:
        sys.exit(f"{W}[{Y}!{W}] Lu jangan ASAL MASUKIN KONTCO{abu}.....")
